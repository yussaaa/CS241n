...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(
            in_features = self.embed_size * self.n_features,
            out_features = self.hidden_size)
        # Initialize the weight for this layer
    ...
    def embedding_lookup(self, t):
        ...
        # x.view(x.size()[0], self.n_features * self.embed_size)
    ...
    def forward(self, t):
        ...
        # 4) Apply drop out
        hidden_dropped = self.dropout(hidden_relu)
        # 5) Apply logistic in the final layer
        logits = self.hidden_to_logits(hidden_dropped)
        ### END YOUR CODE
        return logits
